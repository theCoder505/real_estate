...
// Shared icon resolver used in both the cards and the form preview
const getFacilityIcon = (iconName: string, className = 'w-5 h-5') => {
    ...
    return map[iconName] ?? <Building2 className={className} />;
};
        ...
        post(url, {
            ...
            onSuccess: () => {
                Swal.fire({
                    icon: 'success',
                    title: 'Done!',
                    text: `Facility ${mode === 'edit' ? 'updated' : 'created'} successfully.`,
                    timer: 2500,
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
                ...
                <div className="flex items-center gap-3">
                    {/* Live icon preview */}
                    <div className="shrink-0 p-2.5 bg-orange-100 dark:bg-orange-900/20 text-orange-600 rounded-lg border border-orange-200 dark:border-orange-800">
                        {getFacilityIcon(data.icon)}
                    </div>
                    <select
                        value={data.icon}
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-start justify-between gap-2">
                                        <div>
                                            ...
                                            <span className="inline-block mt-1 text-[10px] bg-zinc-100 dark:bg-zinc-800 px-2 py-0.5 rounded font-mono">
                                                {facility.icon}
                                            </span>
                                        </div>
                ...
                <DialogContent className="max-w-lg">
                    ...
                    {editFacility && (
                        <FacilityForm
                            ...
                            onSuccess={() => setEditFacility(null)}
                            onCancel={() => setEditFacility(null)}
                        />
                    )}
                </DialogContent>
            </Dialog>
