...
<head>
    ...
    <title>Verify Password Change – {{ $brandname }}</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;">
                    ...
                    <tr>
                        <td style="background-color:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 8px 40px rgba(0,0,0,0.08);">
                            ...
                            <!-- Hero band — dark zinc to differentiate from email-change -->
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding-left:16px;">
                                                    <p style="margin:0;font-size:11px;color:rgba(255,255,255,0.55);text-transform:uppercase;letter-spacing:2.5px;font-weight:700;">Account Security</p>
                                                    <h1 style="margin:4px 0 0;font-size:22px;font-weight:800;color:#ffffff;letter-spacing:-0.4px;">Password Change Request</h1>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td style="padding:40px 48px 32px;">
                                        ...
                                        <p style="margin:0 0 24px;font-size:14px;line-height:1.75;color:#52525b;">
                                            We received a request to change the password on your <strong style="color:#18181b;">{{ $brandname }}</strong> account. Use the verification code below to confirm and proceed with the change.
                                        </p>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#fafafa;border-radius:12px;border:1px solid #f4f4f5;margin-bottom:24px;">
                                            <tr>
                                                <td style="padding:18px 20px;border-left:3px solid #18181b;">
                                                    <p style="margin:0 0 10px;font-size:12px;font-weight:700;color:#18181b;text-transform:uppercase;letter-spacing:1px;">🔒 Password Tips</p>
                                                    <table role="presentation" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td style="padding-bottom:6px;font-size:13px;color:#52525b;line-height:1.6;">
                                                        ...
                                                        <tr>
                                                            <td style="font-size:13px;color:#52525b;line-height:1.6;">
                                            ...
                                            <tr>
                                                <td style="padding:14px 18px;">
                                                    <p style="margin:0;font-size:13px;color:#b91c1c;line-height:1.6;">
                                                        ⚠️ &nbsp;<strong>Didn't request this?</strong> If you did not initiate a password change, please ignore this email and consider securing your account immediately.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
