...
class ProfileController extends Controller
{
    ...
    public function sendOtp(Request $request): RedirectResponse
    {
        ...
        $template = $request->type === 'email' ? 'mails.email_change_otp' : 'mails.pwd_change_otp';
        ...
        try {
            ...
            return back()->withErrors(['email' => 'Failed to send OTP email. Please check your mail server settings.']);
        }
